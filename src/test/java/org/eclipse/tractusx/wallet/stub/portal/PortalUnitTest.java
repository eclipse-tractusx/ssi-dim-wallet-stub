...
class PortalUnitTest {
    ...
    void testCreateWalletAndVerifyPortalApiCall() {
        ...
        PortalStubService portalStubService = new PortalStubService(portalClient, new ObjectMapper(), portalSettings, walletStubSettings, didDocumentService, keycloakService);
